...
export default function Add_material() {
    ...
    let handleSubmit = async (e) => {
        ...
        if (
            ...
            try {
                let res = await fetch(
                    `https://sarmicrosystems.in/react_inventory/API/add_material.php`,
                    {
                        method: "POST",
                        body: JSON.stringify({
                            vendor: vendor,
                ...
                if (resJson === 1) {
                    ...
                    setVendor(""); // Reset the vendor field
                    setMaterial(""); // Reset the material field
                    setModel([{ model: "", pono: "", project: "" }]); // Reset the model fields
