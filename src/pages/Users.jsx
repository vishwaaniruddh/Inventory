    ...
    return (
        ...
        <div className="pcoded-main-container">
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <td className="actiondiv">
                                                                            <a className="fa-background" title="Edit"><i className="fas fa-pen" onClick={() => { setModalData(users.userid); setModalShow(true); }}></i></a>
                                                                            <a className="fa-background" title="Roles & Permission" onClick={() => { setrolemodalData(users.userid); setrolemodalShow(true); }}><i className="fa-solid fa-shield-halved"></i></a>
                                                                            <a className="fa-background" title="Delete"><i className="fa-solid fa-trash cursor color-danger" onClick={() => deleteuser(users.userid)}></i></a>
                                                                        </td>
            ...
            </div>
            {
                modalData ?
                    <UserChild
                        show={modalShow} userid={modalData}
...

{
                ...
                <RoleModal
                        show={rolemodalShow} userid={rolemodalData}
